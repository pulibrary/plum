module Hyrax
  module Actors
    class AddAsMemberOfCollectionsActor < ::Hyrax::Actors::AbstractActor
      ...
      private
        ...
        def add_to_collections(collection_ids)
          ...
          other_collections = curation_concern.member_of_collections.select { |coll| !ability.can?(:edit, coll) }
