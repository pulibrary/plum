...
RSpec.describe Workflow::MetadataReviewNotification do
  ...
  describe ".send_notification" do
    it 'sends a message to all users' do
      ...
      expect(ActionMailer::Base.deliveries.first.subject).to eq "[plum] Scanned Resource #{work.id}: Metadata Review"
    end
  end
end
